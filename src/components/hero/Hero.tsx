  ...
  return (
    <SectionLayout id="home" className="hero bg-[var(--accent-color)] min-h-screen pt-[var(--header-height)] flex items-center">
      <div className="container">
        <div className="content relative max-w-[900px] text-center text-white py-8 mx-auto -mt-[var(--header-height)]">
          <h1 className="fs-h1 font-bold relative">
            Design That Builds{" "}
            <span className="text-[var(--primary-color)]">Brands.</span> Website
            That Win <span className="highlight-underline">Customers.</span>
          </h1>
          <p className="text-[clamp(16px,1.8vw,18px)] mt-6 max-w-[600px] mx-auto relative">
          ...
          <div className="mt-12 flex items-center justify-center gap-6">
            <Button
              ...
              className="group inline-flex items-center gap-3 min-h-[60px] rounded-full px-12 text-[18px] relative has-link overflow-hidden"
            >
              Let See the Works
            </Button>
